...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleContentNotFound(Exception ex, HttpServletRequest request) {
        log.warn("Publication content not found: {}", request.getRequestURI());
